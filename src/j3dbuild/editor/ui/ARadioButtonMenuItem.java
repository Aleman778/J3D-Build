...
public class ARadioButtonMenuItem extends JRadioButtonMenuItem {
    ...
    class ARadioButtonMenuItemUI extends BasicRadioButtonMenuItemUI {
        ...
        protected void paintBackground(Graphics g, JMenuItem menuItem,
                Color bgColor) {
            if (hover) {
                g.setColor(ThemeUtils.COLOR_SELECTION);
            } else if (isSelected()) {
                g.setColor(ThemeUtils.COLOR_SELECTION.darker());
            } else {
        ...
        protected void paintText(Graphics g, JMenuItem menuItem,
            ...
            if (hover) {
                g.setColor(ThemeUtils.COLOR_SELECTION.brighter().brighter());
            } else {
