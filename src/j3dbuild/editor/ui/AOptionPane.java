...
public class AOptionPane {
    ...
    public static void showMessage(String title, String message) {
        ...
        JOptionPane.showOptionDialog(Application.instance, getMessagePanel(message), title, JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_OPTION, null, new AButton[]{okBtn}, 0);
    }
    ...
    public static void showErrorMessage(String title, String message) {
        JOptionPane.showMessageDialog(Application.instance, message, title, JOptionPane.ERROR_MESSAGE);
    }

    public static void showWarningMessage(String title, String message) {
        JOptionPane.showMessageDialog(Application.instance, message, title, JOptionPane.WARNING_MESSAGE);
    }

    public static void showInfoMessage(String title, String message) {
        JOptionPane.showMessageDialog(Application.instance, message, title, JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static boolean getQuestion(String title, String message) {
        ...
        JOptionPane.showOptionDialog(Application.instance, getMessagePanel(message), title, JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_OPTION, null, new AButton[]{yesBtn, noBtn}, 0);
    ...
    public static int getQuestionCancel(String title, String message) {
        ...
        JOptionPane.showOptionDialog(Application.instance, getMessagePanel(message), title, JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_OPTION, null, new AButton[]{yesBtn, noBtn, cancelBtn}, 0);
