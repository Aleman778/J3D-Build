...
public class AInternalFrame extends JInternalFrame {
    ...
    public AInternalFrame() {
        ...
        panelTitlebar.setBackground(ThemeUtils.COLOR_ITEM);
        AButton buttonClose = new AButton(false);
        buttonClose.setBG(ThemeUtils.COLOR_ITEM);
        buttonClose.setHighlightBg(ThemeUtils.COLOR_ERROR);
        ...
        labelTitle.setForeground(ThemeUtils.COLOR_ITEM_SELECTED);
        ...
        getContentPane().setBackground(ThemeUtils.COLOR_PANEL);
