...
import j3dbuild.editor.ui.ATextPane;
import j3dbuild.editor.ui.AOptionPane;
import j3dbuild.editor.ui.AButton;
import j3dbuild.editor.ui.ATextField;
import j3dbuild.editor.ui.ATree;
import j3dbuild.editor.ui.ASplitPane;
...
public class FileSetup extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(ThemeUtils.COLOR_BACKGROUND);
    ...
    public void browse() {
        ...
        if (browser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            jTextFieldLocation.setBorder(new LineBorder(ThemeUtils.COLOR_ITEM));
        }
    }
    ...
    public boolean isFile() {
        ...
        if (title.isEmpty()) {
            jTextFieldTitle.setBorder(new LineBorder(ThemeUtils.COLOR_ERROR));
            return false;
        }
        
        if (!location.exists() || !location.isDirectory()) {
            jTextFieldLocation.setBorder(new LineBorder(ThemeUtils.COLOR_ERROR));
            return false;
        }
